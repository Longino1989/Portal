...
where pr.factura=".$folio." and pr.estatus=3 and (us.usuario = '".$datosUser["usuario"]."' or us.usuario = 'admin') and pr.tipoArchivo = 'xml' ");
...
$corta = explode('.',$img["nombre"]); $ext=end($corta);
     if($ext=='xml'){
		echo "<li id='".$img["imagenid"]."'><img src='imgs/verifica.ico'>&nbsp;&nbsp;&nbsp;&nbsp;<img src='imgs/xml.png' ><a href='".$img["direccion"]."'>".$img["nombre"]."<br />&nbsp;&nbsp;&nbsp;<a target='_blank' href='".$img["direccion"]."'>Ver</a></li>";
	}else{
	
	echo"";}
 }
 echo "</ul>";
 //echo"<img src="../../../../../archivosXML/abajo.JPG"";
