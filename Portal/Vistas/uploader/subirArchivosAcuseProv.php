...
$uploaddir = '../../../archivosPDFAcuse/'.$folio; 
...
if($num_rows>0){
	...
	$nombre=$folio."-".$num.basename($sef);
        ...
        $num_rows = sqlsrv_num_rows($re);
	$nombre=$folio."-".$num.basename($sef);
	$uploaddir = '../../../archivosPDFAcuse/'.$folio."-".$num;}
...
$in=sqlsrv_query($sd,"INSERT INTO archivosProveedores(factura,nombre,direccion,estatus,fecha,usuarioidfk,tipoArchivo) VALUES(".$folio.",'".$nombre."','".$file."','3',GETDATE(),".$usuarioID.",'acuse')");
